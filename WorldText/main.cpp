...
//
//        glfwGetWindowSize(window, &w_width, &w_height);
//        projection = glm::ortho(0.0f, static_cast<GLfloat>(w_width), 0.0f, static_cast<GLfloat>(w_height));
////        projection = glm::ortho(static_cast<GLfloat>(w_width) * -0.5f
////                , static_cast<GLfloat>(w_width) * 0.5f
////                , static_cast<GLfloat>(w_height) * -0.5f
////                , static_cast<GLfloat>(w_height) * 0.5f);
//        glUniformMatrix4fv(glGetUniformLocation(text_program_id, "projection"), 1, GL_FALSE, &projection[0][0]);
//
//
...
//
//        RenderText(text_program_id, "Hello Text Rendering", 800.0f, 600.0f, 0.3f, glm::vec3(0.5, 0.8f, 0.2f));
//        RenderText(text_program_id, "(C) LearnOpenGL.com", 0.0f, 0.0f, 0.5f, glm::vec3(0.3, 0.7f, 0.9f));
//
//        // Swap the buffers
